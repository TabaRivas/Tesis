...
class Estimator(Node):
  ...
  def __init__(self_RA):
    ...
    self_RA.odom_subscriber = self_RA.create_subscription(
                           Odometry,
                           '/robot_D/odom',
                           self_RA.odom_callback,
                           10)
    ...
    self_RA.velocity_subscriber = self_RA.create_subscription(
                               Twist,
                               '/robot_D/cmd_vel',
                               self_RA.velocity_callback,
                               10)
 
    # Create a publisher
    # This node publishes the estimated position (x, y, yaw) 
    # The type of message is std_msgs/Float64MultiArray
    self_RA.publisher_state_est = self_RA.create_publisher(
                               Float64MultiArray, 
                               '/robot_D/state_est', 
                               10)
 
  def odom_callback(self_RA, msg):
    """
    ...
    """                    
    roll, pitch, yaw = self_RA.euler_from_quaternion(
    ...
    self_RA.publish_estimated_state(obs_state_vector_x_y_yaw)
 
  def publish_estimated_state(self_RA, state_vector_x_y_yaw):
    """
    ...
    self_RA.publisher_state_est.publish(msg)
 
  def euler_from_quaternion(self_RA, x, y, z, w):
    """
  ...
  def velocity_callback(self_RA, msg):
    """
